...
​
function getArea(radius: number) :void {
    let area: number =  pi * radius ^ 2;
    console.log(`The area of the circle is ${area}`);
}
​
function getDiameter(radius: number) :void {
​    let diameter: number =  radius * 2;
    console.log(`The diameter of the circle is ${diameter}`);
}
​
function getCircumfrence(radius: number) :void {
    let diameter: number =  radius * 2;
    let circumfrence: number = pi * diameter;
